...
class _PatientDetailsPageState extends State<PatientDetailsPage> {
    ...
    if (!context.read<PatientProvider>().areVitalsLoaded()) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        context.read<PatientProvider>()
            .loadVitals(); // Make sure vitals are loaded after the first frame
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    final patient = context.watch<PatientProvider>().getPatient(
        widget.patientId);
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(
                children: [
                  // Overview tab (No add button here)
                  PatientOverviewTab(patient: patient),

                  // Vitals tab with an action button
                  Stack(
                    children: [
                      ...
                      Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            // Add Vitals button with text and icon
                            Container(
                              width: 160,
                              ...
                              child: TextButton.icon(
                                ...
                                icon: const Icon(
                                    Icons.add_chart, color: Colors.deepPurple),
                                label: Column(
                                  children: const [
                                    Text("Add Vitals", style: TextStyle(
                                        color: Colors.deepPurple,
                                        fontSize: 14)),
                                    Text("महत्त्वपूर्ण संकेत जोड़ें",
                                        style: TextStyle(
                                            color: Colors.deepPurple,
                                            fontSize: 12)),
                                  ],
                  ...
                  // Records tab with an action button
                  Stack(
                    children: [
                      ...
                      Align(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            // Add Record button with text and icon
                            Container(
                              width: 160,
                              padding: const EdgeInsets.symmetric(vertical: 12),
                              decoration: BoxDecoration(
                              ...
                              child: TextButton.icon(
                                ...
                                icon: const Icon(
                                    Icons.note_add, color: Colors.deepPurple),
                                label: Column(
                                  children: const [
                                    Text("Add Record", style: TextStyle(
                                        color: Colors.deepPurple,
                                        fontSize: 14)),
                                    Text("रिकॉर्ड जोड़ें", style: TextStyle(
                                        color: Colors.deepPurple,
                                        fontSize: 12)),
                                  ],
                                ),
                  ...
                  // Appointments tab with an action button
                  Stack(
                    children: [
                      ...
                      Align(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            // Add Appointment button with text and icon
                            Container(
                              width: 160,
                              padding: const EdgeInsets.symmetric(vertical: 12),
                              decoration: BoxDecoration(
                              ...
                              child: TextButton.icon(
                                ...
                                label: Column(
                                  children: const [
                                    Text("Add Appointment", style: TextStyle(
                                        color: Colors.deepPurple,
                                        fontSize: 14)),
                                    Text("अपॉइंटमेंट जोड़ें", style: TextStyle(
                                        color: Colors.deepPurple,
                                        fontSize: 12)),
                                  ],
                                ),
