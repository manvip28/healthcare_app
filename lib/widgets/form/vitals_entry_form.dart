                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      symptomLabelHindi,
                      style: TextStyle(
                          fontSize: 18), // Increased font size for Hindi part
                    ),
                  ],
                ),
              ],
  ...
  void _saveVitals() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (heartRate == null || systolic == null || diastolic == null ||
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text(
                'Please enter valid values for all fields. / कृपया सभी क्षेत्रों के लिए सही मान दर्ज करें।')));
        return;
      }
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text(
              'Vitals saved successfully / लक्षण सफलतापूर्वक सहेजे गए')),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(
              'Error saving vitals: {$e} / लक्षण सहेजने में त्रुटि: {$e}')),
        );
      }
    }
  }
    ...
    return Scaffold(
      appBar: AppBar(
        title: Padding(
          ...
          child: const Text('Add Vitals / विटल्स जोड़ें'),
        ),
        leading: Padding(
          padding: const EdgeInsets.only(top: 18.0),
          // Add space to move the icon down
          child: IconButton(
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty)
                      return 'Please enter heart rate / कृपया हृदय गति दर्ज करें';
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty)
                      return 'Please enter systolic blood pressure / कृपया सिस्टोलिक रक्त दबाव दर्ज करें';
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty)
                      return 'Please enter diastolic blood pressure / कृपया डायस्टोलिक रक्त दबाव दर्ज करें';
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty)
                      return 'Please enter body temperature / कृपया शरीर का तापमान दर्ज करें';
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty)
                      return 'Please enter blood sugar / कृपया रक्त शुगर दर्ज करें';
                    return null;
                  },
                ),
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty)
                      return 'Please enter symptom duration / कृपया लक्षणों की अवधि दर्ज करें';
                    return null;
                  },
                ),
                const SizedBox(height: 16),
                _buildSymptomsSection(
                    'Heart Attack Symptoms / हृदय गति के लक्षण',
                    heartAttackSymptoms),
                _buildSymptomsSection(
                    'Hypoglycemic Symptoms / हाइपोग्लाइसीमिया के लक्षण',
