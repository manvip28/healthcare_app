...
class RiskAssessment {
  ...
  static AssessmentResult assessRisk(Vitals vitals) {
    ...
    if (heartAttackSymptomCount >= MINIMUM_SYMPTOMS_FOR_ALERT &&
      ...
      isHighRisk = true;
      alerts.add(
          'WARNING: High risk of heart attack detected. Please seek immediate medical attention. / चेतावनी: हृदयाघात का उच्च जोखिम पाया गया है। कृपया तुरंत चिकित्सा सहायता प्राप्त करें।');
    }
    ...
    if (hypoglycemicSymptomCount >= MINIMUM_SYMPTOMS_FOR_ALERT &&
      ...
      isHighRisk = true;
      alerts.add(
          'WARNING: Risk of hypoglycemic shock detected. Please seek immediate medical attention. / चेतावनी: हाइपोग्लाइसीमिक शॉक का जोखिम पाया गया है। कृपया तुरंत चिकित्सा सहायता प्राप्त करें।');
    }
